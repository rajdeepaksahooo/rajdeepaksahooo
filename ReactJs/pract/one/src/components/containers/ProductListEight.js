...
import ProductComponentEight from './ProductComponentEight'
import axios from 'axios'
import { setProductsEight} from '../redux/actions/ProductActions'
...
const ProductListOne = () => {
    ...
    const fetchProductsOne= async()=>{
        ...
        dispatch(setProductsEight(response.data))
    } 
    ...
    return(
        <div className='ui grid container mt-5' className={classes.main}>
            <ProductComponentEight></ProductComponentEight>
        </div>
    )
}
